...
const TextInputWithImageModal = ({
  visible,
  title,
  placeholder,
  defaultValue = '',
  defaultImage = '',
  showImagePicker = false, // Bật/tắt tính năng chọn ảnh
  onSubmit, // (text, imageUri) => void
  onCancel,
}) => {
  const { colors } = useApp();
          ...
          {showImagePicker && (
            <View style={styles.imageSection}>
              {imageUri ? (
                ...
                >
                  <Icon name="image-outline" size={32} color={colors.iconInactive} />
                </View>
              )}
...
export default TextInputWithImageModal;
